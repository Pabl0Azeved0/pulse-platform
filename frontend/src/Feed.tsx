...
export default function Feed() {
  ...
  if (loading && !data)
    return <div className="text-center mt-20 text-pulse-blue animate-pulse">Loading Pulse...</div>;
  if (error)
    return (
      <div className="text-center mt-20 text-red-500 bg-red-900/10 p-4 rounded">
        System Offline: {error.message}
      </div>
    );
