            ...
            {user ? (
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-pulse-blue to-pulse-green flex items-center justify-center text-black font-bold border-2 border-transparent hover:border-white transition-all overflow-hidden">
                    {user.avatar ? (
                      <img 
                        src={user.avatar} 
                        alt="User" 
